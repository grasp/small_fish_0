...
def validate_history_daily_data(date)
	...
	data_folder=File.expand_path("./history_daily_data","#{AppSettings.resource_path}")
    invalid_history_file=File.expand_path("./data_validate/invalid_history_daily_data.txt","#{AppSettings.resource_path}")
	...
	Dir.new(data_folder).each do |file|
		...
		file_path= 	File.expand_path("./history_daily_data/#{file}","#{AppSettings.resource_path}")
...
def get_invalid_history_daily_data_list_and_delete
	file_path=File.expand_path("./data_validate/invalid_history_daily_data.txt","#{AppSettings.resource_path}")
