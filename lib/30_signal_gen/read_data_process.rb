...
def read_full_data_process_file(stragy_name,symbol)

 processed_file=File.expand_path("#{symbol}.txt",$data_process_path)
...
if $0==__FILE__
  ...
  init_strategy_name(strategy)
	 read_full_data_process_file(strategy,"000009.sz")
