...
#  从今日数组中产生的信号
    ...
    signal_hash["t_ma2_bigger_ma10"]=t_ma_array[1] > t_ma_array[5]
    signal_hash["t_ma2_bigger_ma20"]=t_ma_array[1] > t_ma_array[6]
    signal_hash["t_ma2_bigger_ma30"]=t_ma_array[1] > t_ma_array[7]
    signal_hash["t_ma3_bigger_ma5"]=t_ma_array[2] > t_ma_array[4]
    signal_hash["t_ma3_bigger_ma10"]=t_ma_array[2] > t_ma_array[5]
   # signal_hash["t_ma3_bigger_ma20"]=t_ma_array[2] > t_ma_array[6]
   # signal_hash["t_ma3_bigger_ma30"]=t_ma_array[2] > t_ma_array[7]
 ...
 #  从昨日数组中产生的信号
  ...
  #  signal_hash["t_ma3_bigger_y_ma3"]=t_ma_array[2]   > y_ma_array[2]
   ...
   # signal_hash["t_ma200_bigger_y_ma200"]=t_ma_array[11]   > y_ma_array[11]  
     ...
     signal_hash["ma1ma2ma3"]=(t_ma_array[0] >t_ma_array[1]  ) && (t_ma_array[1] >t_ma_array[2])
     signal_hash["ma1ma2ma4"]=(t_ma_array[0] >t_ma_array[1]  ) && (t_ma_array[1] >t_ma_array[3])
     signal_hash["ma1ma2ma5"]=(t_ma_array[0] >t_ma_array[1]  ) && (t_ma_array[1] >t_ma_array[5])
     signal_hash["ma2ma3ma4"]=(t_ma_array[1] >t_ma_array[2]  ) && (t_ma_array[2] >t_ma_array[3])
     signal_hash["ma3ma4ma5"]=(t_ma_array[2] >t_ma_array[3]  ) && (t_ma_array[3] >t_ma_array[4])


     signal_hash["ma5ma10ma20"]=(t_ma_array[4] >t_ma_array[5]  ) && (t_ma_array[5] >t_ma_array[6])
     signal_hash["ma10ma20ma30"]=(t_ma_array[5] >t_ma_array[6]  ) && (t_ma_array[6] >t_ma_array[7])
    signal_hash["ma20ma30ma60"]=(t_ma_array[6] >t_ma_array[7]  ) && (t_ma_array[7] >t_ma_array[8])
    signal_hash["ma30ma60ma120"]=(t_ma_array[7] >t_ma_array[8]  ) && (t_ma_array[8] >t_ma_array[9])
    signal_hash["ma1ma2ma3ma4"]=(t_ma_array[0] >t_ma_array[1]  ) && (t_ma_array[1] >t_ma_array[2]) && (t_ma_array[2] >t_ma_array[3])
    signal_hash["ma2ma3ma4ma5"]=(t_ma_array[1] >t_ma_array[2]  ) && (t_ma_array[2] >t_ma_array[3]) && (t_ma_array[3] >t_ma_array[4])
    signal_hash["ma3-10"]=(t_ma_array[2] >t_ma_array[3]  ) && (t_ma_array[3] >t_ma_array[4]) && (t_ma_array[4] >t_ma_array[5])
